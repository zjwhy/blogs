...
class WebElement(metaclass=abc.ABCMeta):
    ...
    def input(self, text: str, *, simulative=True, append=False, contains_hotkey=False, send_key_delay=50, focus_timeout=1000, delay_after=1, anchor=None) -> typing.NoReturn:
        '''
        填写网页输入框
    ...
    def get_bounding(self, to96dpi=True) -> typing.Tuple:
        '''
        获取网页元素的边框属性组合
        * @param to96dpi, 是否需要将边框属性转换成dpi为96的对应属性值
        * @return `typing.Tuple`, 返回网页元素的边框属性组合, 如('x', 'y', 'width', 'height')
        '''

        bd = self._invoke('GetBounding', {'to96dpi': to96dpi})
    ...
    def upload(self, file_names, *, simulative=False, clipboard_input=True, dialog_timeout=20, send_key_delay=50, focus_timeout=1000) -> typing.NoReturn:
        '''
        上传文件
    ...
    def download(self, file_folder, *, file_name=None, wait_complete=True, wait_complete_timeout=300, simulative=False, clipboard_input=True, dialog_timeout=20, send_key_delay=50, focus_timeout=1000) -> str:
        '''
        下载文件
